                ...
                fAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            ...
                            Toast.makeText(ViewRegister.this, "User Created.", Toast.LENGTH_SHORT).show();
...
/*                            final FirebaseUser currentUser = fAuth.getCurrentUser();
                            ...
                            progressBar.setVisibility(View.INVISIBLE);
                            Toast.makeText(ViewRegister.this, "Error Occurred! " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
